...
#Region "Property"
    ...
    Private _sqlConnect As OracleConnection = Nothing
    Private _sqlAdapter As OracleDataAdapter = Nothing
    Private _sqlReader As OracleDataReader = Nothing
    Private _sqlCommand As OracleCommand = Nothing
...
#Region "Constructor"
    Public Sub New(ByVal server As EnumServers)
        _server = server
        _sqlConnect = New OracleConnection(GetConnectString(server))
        OpenConnect()
    End Sub

    Public Sub New(ByVal connectString As String)
        _sqlConnect = New OracleConnection(connectString)
        OpenConnect()
    End Sub
#End Region
...
#Region "Functions"
    ...
    Function FillDataTable(ByVal selectCommand As String) As DataTable Implements IDBFunction.FillDataTable
        ...
        _sqlCommand = New OracleCommand(selectCommand, _sqlConnect)
        _sqlCommand.CommandTimeout = 0
        _sqlCommand.Transaction = _sqlTransaction
        _sqlAdapter = New OracleDataAdapter(_sqlCommand)
        _sqlAdapter.Fill(tb)
        Return tb
    End Function
    ...
    Function FillDataTable(ByVal OracleCommand As DbCommand) As DataTable Implements IDBFunction.FillDataTable
        ...
        OracleCommand.Connection = _sqlConnect
        OracleCommand.Transaction = _sqlTransaction
        _sqlAdapter = New OracleDataAdapter(OracleCommand)
        _sqlAdapter.Fill(tb)
        Return tb
    End Function
    ...
    Function FillDataSet(ByVal selectCommand As String) As DataSet Implements IDBFunction.FillDataSet
        ...
        _sqlAdapter = New OracleDataAdapter(selectCommand, _sqlConnect)
        _sqlAdapter.Fill(ds)
        Return ds
    End Function
    ...
    Function ExecuteNonQuery(ByVal commandText As String) As Integer Implements IDBFunction.ExecuteNonQuery
        OpenConnect()
        _sqlCommand = New OracleCommand(commandText, _sqlConnect)
        _sqlCommand.CommandTimeout = 0
        _sqlCommand.Transaction = _sqlTransaction
    ...
    Function ExecuteStoreProcedure(ByVal sp_name As String) As Integer
        OpenConnect()
        _sqlCommand = New OracleCommand(sp_name, _sqlConnect)
        _sqlCommand.CommandTimeout = 0
        _sqlCommand.CommandType = CommandType.StoredProcedure
        _sqlCommand.Transaction = _sqlTransaction
        Return _sqlCommand.ExecuteNonQuery()
    ...
    Function Update(Of T)(ByVal obj As T) As Integer Implements IDBFunction.Update
        OpenConnect()
        _sqlCommand = New OracleCommand(CreateCommandUpdate(Of T)(obj), _sqlConnect)
        _sqlCommand.Parameters.AddRange(CreateParameter(Of T)(obj))
        _sqlCommand.Transaction = _sqlTransaction
        _sqlCommand.CommandTimeout = 3
        Return _sqlCommand.ExecuteNonQuery()
    End Function
    Function Update(Of T)(ByVal obj As T, ByVal condition As String) As Integer
        OpenConnect()
        _sqlCommand = New OracleCommand(CreateCommandUpdate(Of T)(obj, condition), _sqlConnect)
        _sqlCommand.Parameters.AddRange(CreateParameter(Of T)(obj))
        _sqlCommand.Transaction = _sqlTransaction
        _sqlCommand.CommandTimeout = 3
        Return _sqlCommand.ExecuteNonQuery()
    ...
    Function Insert(Of T)(ByVal obj As T) As Integer Implements IDBFunction.Insert
        OpenConnect()
        _sqlCommand = New OracleCommand(CreateCommandInsert(Of T)(obj), _sqlConnect)
        _sqlCommand.Parameters.AddRange(CreateParameter(Of T)(obj))
        _sqlCommand.Transaction = _sqlTransaction
        _sqlCommand.CommandTimeout = 3
        Return _sqlCommand.ExecuteNonQuery()
    ...
    Function Delete(Of T)(ByVal obj As T) As Integer Implements IDBFunction.Delete
        OpenConnect()
        _sqlCommand = New OracleCommand(CreateCommandDelete(obj), _sqlConnect)
    ...
    Sub GetObject(Of T)(ByRef obj As T) Implements IDBFunction.GetObject
        ...
        _sqlCommand = New OracleCommand(CreateCommandSelect(obj), _sqlConnect)
        _sqlCommand.CommandTimeout = 0
        _sqlCommand.Parameters.AddRange(CreateParameterKey(obj))
        _sqlCommand.Transaction = _sqlTransaction
    ...
    Function GetKeysOfTable(ByVal tableName As String) As DataTable
        Dim sql As String = ""
        sql = String.Format("")
        _sqlCommand = New OracleCommand("sp_pkeys")
        _sqlCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Sub OpenConnect() Implements IDBFunction.OpenConnect
        If _sqlConnect IsNot Nothing Then
            ...
            End If
        Else
            _sqlConnect = New OracleConnection(GetConnectString(_server))
            _sqlConnect.Open()
        End If
    End Sub
